...
const FOOTER_COMPLETO = `<footer>
  ...
  <div class="ftr-main">
    <div class="ftr-col ftr-col-brand">
      ...
      <a class="ftr-wpp" href="https://wa.me/555197698450"><svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path d="M12 2a10 10 0 0 0-8.6 15l-1.3 4.7 4.8-1.3A10 10 0 1 0 12 2zm0 2a8 8 0 1 1-4.1 14.9l-.3-.2-2.8.7.8-2.7-.2-.3A8 8 0 0 1 12 4z"/></svg> Falar no WhatsApp</a>
    </div>
    <div class="ftr-col">
...
const HEADER_COMPLETO = `<header class="desk-header" id="desk-header">
  <div class="desk-header-inner">
    ...
    <a class="dh-cta" href="https://wa.me/555197698450" target="_blank" rel="nofollow">
...
const MAPAS_IMPLANTACAO = Object.freeze({
  ...
  'enseada-lagos-de-xangri-la-xangri-la':'10-Enseada.webp',
  ...
  'condominio-maquine-la-marina':'40-LaMarina.webp',
  ...
  'allure-beach-condo-xangri-la':'Allure.webp',
  'pacific-residence-xangri-la':'24-Pacific.webp',
  'atlantida-lagos-park-xangri-la':'16-LagosPark.webp',
  'las-dunas-xangri-la':'17-LasDunas.webp',
  'lagoa-do-passo-xangri-la':'15-LagoadoPasso.webp',
  'la-plage-xangri-la':'14-LaPlage.webp',
  'casa-hermosa-xangri-la':'5-CasaHermosa.webp',
  'malibu-beach-residence-xangri-la':'20-Malibu.webp',
  'one-atlantida-houses-xangri-la':'23-One.webp',
  'playa-vista-xangri-la':'26-PlayaVista.webp',
  'porto-coronado-xangri-la':'27-PortoCoronado.webp',
  'riviera-xangri-la':'29-Riviera.webp',
  'rossi-atlantida-xangri-la':'30-Rossi.webp',
  'sea-coast-xangri-la':'31-SeaCoast.webp',
  'velas-da-marina-xangri-la':'32-VelasdaMarina.webp',
  'ventura-club-xangri-la':'33-VenturaClub.webp',
  'villaggio-xangri-la':'34-Vilaggio.webp',
});
...
function preencherPagina(filerel, cond, imoveis) {
  ...
  // Troca o footer simplificado pelo footer completo do site (com logo Condomínios na Praia)
