...
<tr><td style="padding:25px 26px 23px;background:#123d4b;color:#fff"><div style="font:700 10px Arial,sans-serif;letter-spacing:2px;color:#d7bb72;text-transform:uppercase">PORTAL MEU LITORAL · CRÉDITO IMOBILIÁRIO</div><div style="margin-top:10px;font:700 28px/1.1 Georgia,serif">Crédito contemplado<br><span style="color:#d7bb72">para comprar seu imóvel</span></div><div style="margin-top:13px;font:13px/1.5 Arial,sans-serif;color:#dce9eb">Uma opção de crédito já contemplada, apresentada para sua análise com clareza e segurança.</div></td></tr>
