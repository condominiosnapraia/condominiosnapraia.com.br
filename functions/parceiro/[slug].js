...
<section class="hero"><img class="hero-bg" src="${esc(cover)}" alt="Paisagem de condomínio de alto padrão no litoral do Rio Grande do Sul" fetchpriority="high"><div class="hero-inner"><div class="eyebrow">Atendimento imobiliário no Rio Grande do Sul</div><h1>${esc(pageTitle)}</h1><p>${esc(description)}</p><div class="hero-actions"><a class="hero-action primary" href="#buscar" data-intent="buy">Quero comprar</a><a class="hero-action secondary" href="#contato" data-intent="sell">Quero vender</a></div><div class="hero-quick"><span>${totalProperties} imóveis disponíveis</span><span>Atendimento personalizado</span><span>WhatsApp direto</span></div></div></section>
<main class="main">
...
<section class="intent-row" aria-label="Atalhos de atendimento"><a href="#buscar" data-intent="buy"><strong>Quero comprar</strong><span>Encontre imóveis por cidade, condomínio ou tipo.</span></a><a href="#contato" data-intent="sell"><strong>Quero vender</strong><span>Fale com o corretor para avaliar seu imóvel.</span></a></section><section id="imoveis"><div class="section-intro"><span class="eyebrow">Carteira completa</span><h2 class="sr-title">Imóveis à venda</h2><p class="intro-text">Use a busca para encontrar qualquer imóvel da carteira ou abra uma página individual para consultar detalhes, condomínio e atendimento.</p></div>${sectionMarkup}</section>
