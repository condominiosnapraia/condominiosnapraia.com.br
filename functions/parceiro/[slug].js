...
<section class="hero"><img class="hero-bg" src="${esc(cover)}" alt="Paisagem de condomínio de alto padrão no litoral do Rio Grande do Sul" fetchpriority="high"><div class="hero-inner"><div class="eyebrow">Atendimento imobiliário no Rio Grande do Sul</div><h1>${esc(pageTitle)}</h1><p>${esc(description)}</p></div></section>
<main class="main">
