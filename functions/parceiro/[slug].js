...
<meta property="og:title" content="${esc(pageTitle)} | Condomínios na Praia">
...
<section class="hero">${site.capa_url ? `<img class="hero-bg" src="${esc(site.capa_url)}" alt="" fetchpriority="high">` : ''}<div class="hero-inner"><div class="eyebrow">Imóveis de alto padrão no Rio Grande do Sul</div><h1>${esc(pageTitle)}</h1><p>${esc(description)}</p></div></section>
