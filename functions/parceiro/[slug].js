...
<body>
<header class="site-header"><nav class="nav"><a class="brand" href="${BASE}/">${logo}<span>${esc(name)}</span></a><div class="nav-links"><a href="#buscar">Buscar</a><a href="#imoveis">Imóveis</a><a href="${contactUrl}">Contato</a><a class="nav-cta" href="${esc(wpp)}" target="_blank" rel="noopener nofollow">WhatsApp</a></div></nav></header>
