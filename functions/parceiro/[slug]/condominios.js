...
:root{--brand:#0b5368;--accent:#f4bf61;--ink:#0b2733;--muted:#5c7479;--sand:#f4f8f6;--line:#dce9e6;--white:#fff;--soft:#e9f5f2}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--sand);color:var(--ink);font-family:'DM Sans',Outfit,Arial,sans-serif;overflow-x:hidden}a{text-decoration:none;color:inherit}.nav-links .footer-quick-title,.nav-links .footer-quick-links{display:none!important}
...
<footer><div class="footer-inner"><div class="footer-grid"><div><div class="footer-brand">${esc(name)}</div><p class="footer-copy">Condomínios selecionados e oportunidades imobiliárias para encontrar seu próximo imóvel.</p><a class="footer-wpp" href="${esc(wpp)}" target="_blank" rel="noopener nofollow">Falar pelo WhatsApp</a></div><div class="footer-col"><div class="footer-title">Navegação</div><a href="${landingUrl}">Início do corretor</a><a href="${fullListingUrl}">Todos os imóveis</a><a href="${contactUrl}">Contato</a><a href="${BASE}/">Portal Condomínios na Praia</a></div><div class="footer-col"><div class="footer-title">Acesso rápido</div><div class="footer-quick-links"><a href="${fullListingUrl}">Todos os imóveis</a><a href="${fullListingUrl}?cat=casa-condominio">Casas e sobrados</a><a href="${fullListingUrl}?cat=terreno-condominio">Lotes e terrenos</a><a href="${fullListingUrl}?cat=apartamento">Apartamentos</a></div></div><div class="footer-col"><div class="footer-title">Informações</div>${site.creci ? `<span class="footer-info-creci">CRECI ${esc(site.creci)}</span>` : }<a href="${BASE}/politica-privacidade/">Política de Privacidade</a><a href="${BASE}/termos/">Termos de Uso</a></div></div><div class="footer-bottom"><span>© 2026 ${esc(name)} · Site parceiro Condomínios na Praia</span><span>Rio Grande do Sul · Brasil</span></div></div></footer>
<script>
(function(){
