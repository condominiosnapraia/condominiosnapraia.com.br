        ...
        <div class="cc-hero-grid">
          <div>
            ...
            <div class="cc-hero-actions">
              <a class="cc-hero-action cc-hero-action-primary" href="{esc(wpp)}" target="_blank" rel="noopener">Confirmar disponibilidade</a>
          ...
          <div class="cc-hero-card">
            ...
            <div class="cc-hero-mini" aria-label="Resumo das condições">
              <div class="cc-mini-item"><div class="cc-mini-label">Entrada</div><div class="cc-mini-value">{esc(entry)}</div></div>
              <div class="cc-mini-item"><div class="cc-mini-label">Parcela</div><div class="cc-mini-value">{esc(installment)}</div></div>
              <div class="cc-mini-item"><div class="cc-mini-label">Prazo</div><div class="cc-mini-value">{term}x</div></div>
            </div>
          </div>
        </div>
      </div>
