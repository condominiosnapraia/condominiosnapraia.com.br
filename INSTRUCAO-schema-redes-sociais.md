# Quando criar as redes sociais — completar o schema "sameAs"
...
## Onde ajustar (quando tiver Instagram/Facebook)

1. HOME — arquivo index.html: procure por  sameAs:[  (tem um comentário AJUSTAR
   ao lado). Troque por:
...
link condominiosnapraia.com.br na bio. Isso reforça a associação marca↔site.
